...
if (age >= 0) {
    ...
    if (question.toLowerCase() === "location") {
        ...
        const confirmation = confirm(`You have to pay £${fullPrice} for this ride to ${location}.`)

    } else alert("Refresh and write the correct option!")

    if (confirmation) alert("All good")
    else alert("Hope you have strong legs");
} else(alert("Refresh and add the correct age"))